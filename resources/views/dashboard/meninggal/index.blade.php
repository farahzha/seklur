        ...
        <div class="col-span-9 bg-slate-orange-200 p-5 space-y-20 bg-slate-200">
            ...
            <div class="space-y-5 bg-white rounded-xl">
                ...
                <div class="p-5">
                    ...
                    <form action="{{ route('data-meninggal.index') }}" class="flex justify-end">
                                    ...
                                    <table
                                        ...
                                        <tbody class="bg-[#ECECEC]">
                                            ...
                                            <tr class="border-b dark:border-neutral-500">
                                                ...
                                                <td class="whitespace-nowrap border-r px-4 py-2 dark:border-neutral-500 flex gap-3">
                                                    <a href="{{ route('data-meninggal.edit', $d->id) }}" class="cursor-pointer">
                                                    ...
                                                    <form action="{{ route('data-meninggal.destroy', $d->id) }}" class="cursor-pointer" method="POST">
                                                        @csrf
                                                        @method('DELETE')
